---
description: Isaac Sim، Isaac ROS، اور Nav2 کا استعمال کرتے ہوئے ایک خود مختار ہیومنائیڈ
  تیار کریں جو نیویگیٹ کرتا ہے۔ یہ آپ کے حتمی روبوٹ تک پہنچنے کا آدھا سفر ہے۔
id: isaac-capstone
keywords:
- capstone
- navigation
