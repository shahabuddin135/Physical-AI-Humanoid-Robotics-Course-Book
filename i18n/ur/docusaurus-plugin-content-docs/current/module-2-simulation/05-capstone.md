---
description: روبوٹ کی جانچ کے لیے ایک مکمل سمولیشن ماحول تیار کریں۔ رکاوٹوں، سینسرز،
  اور ایک نیویگیٹ کرنے والے روبوٹ کے ساتھ ایک دنیا بنائیں۔
...
- capstone
- hands-on
title: 'Module 2 Capstone: آپ کا ورچوئل آزمائشی میدان'
---

# Module 2 Capstone: آپ کا ورچوئل ٹیسٹنگ گراؤنڈ

> **TL;DR:** اب وقت ہے کہ آپ اپنی سمولیشن کی مہارتوں کو عملی جامہ پہنائیں۔ آپ ایک مکمل ٹیسٹنگ ماحول بنائیں گے: ایک دنیا، سینسرز والا ایک روبوٹ، اور ایک نیویگیشن ٹیسٹ کورس۔ جب آپ کام مکمل کر لیں گے، تو آپ کے پاس ایک سینڈ باکس ہوگا جہاں آپ بغیر کسی نتائج کے چیزوں کو توڑ سکتے ہیں۔

---

## آپ کیا بنائیں گے

ایک مکمل سمولیشن سیٹ اپ:
- ✅ کسٹم Gazebo world (انڈور گودام طرز کا)
- ✅ LiDAR اور Camera کے ساتھ روبوٹ
- ✅ ROS 2 انٹیگریشن (sensor topics، کنٹرول)
- ✅ Launch file جو سب کچھ شروع کرتا ہے
- ✅ نیویگیشن ٹیسٹ کورس
...
## مرحلہ 2: گودام کی دنیا

`worlds/warehouse.sdf` بنائیں:
...
## مرحلہ 3: سینسرز والا روبوٹ

`models/robot_with_sensors/model.sdf` بنائیں:
...
`launch/simulation.launch.py` بنائیں:
...
ایک اور ٹرمینل میں، روبوٹ کو چلائیں:

```bash
ros2 run teleop_twist_keyboard teleop_twist_keyboard
```

RViz میں سینسرز دیکھیں:
...
ایک Node لکھیں جو:
1. رکاوٹوں سے بچنے کے لیے LiDAR ڈیٹا پڑھتا ہے
2. (7, 7) پر سبز goal marker کی طرف بڑھتا ہے
3. ہدف تک پہنچنے پر رک جاتا ہے

اشارہ: ایک سادہ state machine استعمال کریں:
- `TURN_TO_GOAL` — ہدف کی طرف رخ کرنے کے لیے گھومیں
- `MOVE_FORWARD` — اگر کوئی رکاوٹ نہ ہو تو سیدھا جائیں
- `AVOID_OBSTACLE` — رکاوٹوں سے دور مڑیں
- `GOAL_REACHED` — رکیں اور جشن منائیں

---

## آپ نے کیا سیکھا

✅ Gazebo SDF worlds بنانا
✅ سینسرز کے ساتھ روبوٹ models کی تعریف کرنا
✅ LiDAR اور camera simulation
✅ ROS 2 ↔ Gazebo bridging
✅ Launch file انٹیگریشن

---

## اگلا Module

آپ کا روبوٹ اب ایک ورچوئل دنیا کو سمجھ سکتا ہے۔ اب NVIDIA Isaac کے ساتھ اگلے درجے پر جانے کا وقت ہے—photorealistic simulation، synthetic data، اور GPU-accelerated perception۔

**→ [Module 3: AI-Robot Brain (NVIDIA Isaac)](/docs/module-3-isaac)**